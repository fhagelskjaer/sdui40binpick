...
def main():
    ...
    output_name = "grasp_pose_obj_wrs_24.pickle" 
    model_name_def = "../data/24_37D-GEARMOTOR-50-70.roty90.stl"
    ...
    finger_opening = 20
    orient_object = compute_obj_orientation(model_name_def, center_offset=[10, 0, 0], rotation_info=['z', 90])
    x_angle = 0
